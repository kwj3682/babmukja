...
<script>
     var noticeNo = '${detail.noticeNo}';    //`${detail.noticeNo}`; //게시글 번호
	...
	$.ajax({
        url : '/babmukja/notice/commentList.do',
        type : 'GET',
        data : data,
...
//  }); */
   //댓글 등록
    ...
    $.ajax({
        url : '/babmukja/notice/commentInsert',
        type : 'post',
        data : insertData,
        success : function(data){
            if(data == 1) {
 ...
 //댓글 수정 - 댓글 내용 출력을 input 폼으로 변경 
    ...
    $.ajax({
        url : '/babmukja/notice/commentUpdate',
        type : 'post',
   ...
   function commentDelete(commentNo){
    $.ajax({
        url : '/babmukja/notice/commentDelete/'+commentNo,
        type : 'post',
        success : function(data){
