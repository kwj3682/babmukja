...
<body>
    ...
    <div id="paragraph">자신만의 레시피를 완성해주세요
     <br>
            <br>
            레시피에 맞는 키워드들을 선택해주세요.
    </div>
        <input type="hidden" value="${keyword.caution}" id="hiddenCaution">
        <input type="hidden" value="${keyword.country}" id="hiddenCountry">
        <input type="hidden" value="${keyword.situation}" id="hiddenSituation">
        <input type="hidden" value="${keyword.level}" 	id="hiddenLevel">
        <input type="hidden" value="${keyword.time}" 	id="hiddenTime">
        <input type="hidden" value="${keyword.type}" 	id="hiddenType">
...
<script src="<c:url value="/resources/js/recipe/updateform.js"/>"></script>
</body>
</html>