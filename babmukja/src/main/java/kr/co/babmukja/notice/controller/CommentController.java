...
public class CommentController {
	    ...
	    @ResponseBody
	    private List<Comment> commentList(Model model) throws Exception{
	        return service.commentList();
	    }
	    
	    @RequestMapping("/comment-insert.do") //댓글 작성 
	    @ResponseBody
	    private int CommentInsert(@RequestParam int noticeNo, @RequestParam String content) throws Exception {
